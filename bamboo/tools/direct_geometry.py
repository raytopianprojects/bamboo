...
def getNearProjectionPoint(nodePath):
    ...
    # on the near plane
    origin = nodePath.getPos(base.bamboo.camera)
    # project this onto near plane
    if origin[1] != 0.0:
        return origin * (base.bamboo.dr.near / origin[1])
    else:
        # Object is coplaner with camera, just return something reasonable
        return Point3(0, base.bamboo.dr.near, 0)
...
def getScreenXY(nodePath):
    ...
    nearX = CLAMP(nearVec[0], base.bamboo.dr.left, base.bamboo.dr.right)
    nearY = CLAMP(nearVec[2], base.bamboo.dr.bottom, base.bamboo.dr.top)
    # What percentage of the distance across the screen is this?
    percentX = (nearX - base.bamboo.dr.left)/base.bamboo.dr.nearWidth
    percentY = (nearY - base.bamboo.dr.bottom)/base.bamboo.dr.nearHeight
...
def getCrankAngle(center):
    ...
    x = base.bamboo.dr.mouseX - center[0]
    y = base.bamboo.dr.mouseY - center[2]
