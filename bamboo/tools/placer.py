...
from bamboo.directtools.DirectGlobals import ZERO_VEC, UNIT_VEC
import Pmw
...
class Placer(AppShell):
    ...
    def __init__(self, parent=None, **kw):
        ...
        optiondefs = (
            ...
            ('nodePath',    base.bamboo.camera,      None),
        )
    ...
    def appInit(self):
        # Initialize state
        self.tempCS = base.bamboo.group.attachNewNode('placerTempCS')
        self.orbitFromCS = base.bamboo.group.attachNewNode(
            'placerOrbitFromCS')
        self.orbitToCS = base.bamboo.group.attachNewNode('placerOrbitToCS')
        ...
        self.refNodePathDict['camera'] = base.bamboo.camera
        self.refNodePathDict['widget'] = base.bamboo.widget
    ...
    def xform(self, value, axis):
        ...
        if self.nodePathMenu.get() == 'widget':
            if base.bamboo.manipulationControl.fSetCoa:
    ...
    def xformStop(self, data):
        ...
        if self.nodePathMenu.get() == 'widget':
            ...
            base.bamboo.manipulationControl.spawnFollowSelectedNodePathTask()
