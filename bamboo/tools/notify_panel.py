...
class NotifyPanel:
    ...
    def __init__(self, directNotify, tl=None):
        ...
        from bamboo.showbase.TkGlobal import Pmw, Toplevel, Frame, Label, Radiobutton
        from bamboo.showbase.TkGlobal import HORIZONTAL, X, W, NW, BOTH, LEFT, RIGHT, IntVar
