...
from bamboo.showbase import three_up_show
...
if 0:
    ...
    # This is here because Window sets up a drive interface, this
    # can be removed if Window is changed to not set that up.
    base.use_drive()
    base.disable_mouse()
