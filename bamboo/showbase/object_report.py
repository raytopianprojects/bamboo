"""
>>> from bamboo.showbase import ObjectReport
...
from bamboo.showbase import DirectObject, ObjectPool, GarbageReport
from bamboo.showbase.PythonUtil import makeList, Sync
import gc
import sys
