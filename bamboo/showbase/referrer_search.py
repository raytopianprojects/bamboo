...
import sys
import gc
from bamboo.showbase.PythonUtil import _getSafeReprNotify
...
"""
from bamboo.showbase.ReferrerSearch import ReferrerSearch
door = simbase.air.doFind("DistributedBuildingDoorAI")
class A: pass
door = A()
ReferrerSearch()(door)
reload(ReferrerSearch); from bamboo.showbase.PythonUtil import ReferrerSearch
"""
