...
from bamboo.stdpy.file import open
import sys
import marshal
import imp
import types
...
#: union.  Thus, you can have a bamboo.showbase.foo in your own
#: application, and loading it won't shadow the system
#: bamboo.showbase.Window which is in a different directory on disk.
sharedPackages = {}
...
class VFSSharedLoader:
    ...
    def load_module(self, fullname):
        ...
        # loaded.
        mod._vfs_shared_path = vfs_shared_path + \
            [l.dir_path for l in self.loaders]
