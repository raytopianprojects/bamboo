...
from bamboo.interval.MetaInterval import Parallel
from bamboo.interval.LerpInterval import LerpHprInterval
import sys

# Create an instance of Window, which will open a window and set up a
