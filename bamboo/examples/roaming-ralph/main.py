...
class RoamingRalphDemo(Window):
    def __init__(self):
        ...
        self.c_trav.addCollider(self.ralphGroundColNp, self.ralphGroundHandler)
    ...
    def move(self, task):
        ...
        # However, the class Window that we inherit from has a task to do
        # this for us, if we assign a CollisionTraverser to self.c_trav.
