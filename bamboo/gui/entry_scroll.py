...
class EntryScroll(Frame):
    def __init__(self, entry, parent=None, **kw):
        ...
        self.clipXMin = 0.0
        self.clipXMax = 0.0
        self.initialiseoptions(EntryScroll)
    ...
    def setEntry(self, entry):
        """
        Sets a Entry element for this scroll frame. A EntryScroll
        ...
        is already set.
        """
        assert self.entry is None, "An entry was already set for this EntryScroll element"
        self.entry = entry
        self.entry.reparentTo(self.canvas)
