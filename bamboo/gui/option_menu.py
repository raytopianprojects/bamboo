...
class OptionMenu(Button):
    """
    OptionMenu(parent) - Create a Button which pops up a
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.popupMarker = self.create_component(
            'popupMarker', (), None,
            Frame, (self,),
        ...
        if self['clickSound']:
            ...
            self.popupMarker.guiItem.clearSound(
                DGG.B1PRESS + self.popupMarker.guiId)
        ...
        self.cancelFrame = self.create_component(
            'cancelframe', (), None,
            Frame, (self,),
            frameSize=(-1, 1, -1, 1),
            relief=None,
    ...
    def setItems(self):
        ...
        self.popupMenu = self.create_component('popupMenu', (), None,
                                               Frame,
                                               (self,),
                                               relief='raised',
                                               )
        ...
        for item in self['items']:
            c = self.create_component(
                'item%d' % itemIndex, (), 'item',
                Button, (self.popupMenu,),
    ...
    def showPopupMenu(self, event=None):
        ...
        assert items and len(
            items) > 0, 'Cannot show an empty popup menu! You must add items!'
        ...
        if minZ < -1.0:
            ...
            self.popupMenu.setZ(ShowBaseGlobal.render2d,
                                pos[2] + (-1.0 - minZ))
        elif maxZ > 1.0:
    ...
    def _highlightItem(self, item, index):
        ...
        item['frameSize'] = (self['highlightScale'][0]*self.minX, self['highlightScale'][0]
                             * self.maxX, self['highlightScale'][1]*self.minZ, self['highlightScale'][1]*self.maxZ)
