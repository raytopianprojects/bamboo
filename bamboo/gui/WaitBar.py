"""Contains the WaitBar class, a progress bar widget.
...
"""
import WaitBar
d = WaitBar(borderWidth=(0, 0))
"""


class WaitBar(Frame):
    """ WaitBar - A DirectWidget that shows progress completed
    towards a task.  """
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.initialiseoptions(WaitBar)
        self.updateBarStyle()
