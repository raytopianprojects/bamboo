"""Contains the Entry class, a type of DirectGUI widget that accepts
...
class Entry(Frame):
    """
    Entry(parent) - Create a DirectGuiWidget which responds
    to keyboard buttons
    """
    ...
    def __init__(self, parent=None, **kw):
        ...
        optiondefs = (
            ...
            # NOTE: This overrides the Frame text option
            ...
            ('autoCapitalizeAllowPrefixes', Entry.AllowCapNamePrefixes, None),
            ('autoCapitalizeForcePrefixes', Entry.ForceCapNamePrefixes, None),
        )
        ...
        self.onscreenText = self.create_component(
            'text', (), None,
            OnscreenText,
        ...
        if not hasattr(self, 'autoCapitalizeAllowPrefixes'):
            self.autoCapitalizeAllowPrefixes = Entry.AllowCapNamePrefixes
        if not hasattr(self, 'autoCapitalizeForcePrefixes'):
            self.autoCapitalizeForcePrefixes = Entry.ForceCapNamePrefixes
