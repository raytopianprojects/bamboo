...
class ScrollBar(Frame):
    """
    ScrollBar -- a widget which represents a scroll bar the user can
    ...
    def __init__(self, parent=None, **kw):
        ...
        self.thumb = self.create_component(
            "thumb", (), None,
            Button, (self,),
            borderWidth=self['borderWidth'])
        self.incButton = self.create_component(
            "incButton", (), None,
            Button, (self,),
            borderWidth=self['borderWidth'])
        self.decButton = self.create_component(
            "decButton", (), None,
            Button, (self,),
            borderWidth=self['borderWidth'])
        ...
        self.initialiseoptions(ScrollBar)
