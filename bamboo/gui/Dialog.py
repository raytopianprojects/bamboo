...
__all__ = [
    'findDialog', 'cleanupDialog', 'Dialog', 'OkDialog',
...
def findDialog(uniqueName):
    ...
    """
    if uniqueName in Dialog.AllDialogs:
        return Dialog.AllDialogs[uniqueName]
    return None
...
def cleanupDialog(uniqueName):
    ...
    if uniqueName in Dialog.AllDialogs:
        ...
        Dialog.AllDialogs[uniqueName].cleanup()
...
class Dialog(Frame):
    ...
    def __init__(self, parent=None, **kw):
        ...
        optiondefs = (
            ...
            ('dialogName',        'DirectDialog_' + \
             repr(Dialog.PanelIndex), DGG.INITOPT),
            ...
            ('image', DGG.get_default_dialog_geom(), None),
            ('relief', DGG.get_default_dialog_relief(), None),
        ...
        #    self['dialogName'] = 'DirectDialog_' + repr(Dialog.PanelIndex)
        ...
        Dialog.AllDialogs[self['dialogName']] = self
        Dialog.PanelIndex += 1
    ...
    def cleanup(self):
        ...
        if uniqueName in Dialog.AllDialogs:
            del Dialog.AllDialogs[uniqueName]
        self.destroy()
...
class RetryCancelDialog(Dialog):
    def __init__(self, parent=None, **kw):
        # Inherits from Frame
        optiondefs = (
            # Define type of DirectGuiWidget
