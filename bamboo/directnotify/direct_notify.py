...
from bamboo.directnotify.notifier import Notifier
...
class DirectNotify:
    ...
    def __init__(self):
        ...
        # This will get filled in later by Window.py with a
    ...
    def newCategory(self, categoryName, logger=None):
        ...
        if categoryName not in self.__categories:
            self.__categories[categoryName] = Notifier(
                categoryName, logger)
    ...
    def setDconfigLevel(self, categoryName):
        ...
        # we're running before Window has finished initializing
    ...
    def popupControls(self, tl=None):
        ...
        import importlib
        NotifyPanel = importlib.import_module('bamboo.tkpanels.NotifyPanel')
