...
from . import sprite_particle_renderer_ext
...
class Particles(ParticleSystem):
    ...
    def setRenderer(self, type):
        ...
        if (type == "PointParticleRenderer"):
            ...
            if __dev__:
                from bamboo.directtools import DirectSelection
            ...
            self.renderer = sprite_particle_renderer_ext.SpriteParticleRendererExt()
